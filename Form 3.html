       ...
       <div class="container">
          <h4>Current Address</h4>
            ...
            <div class="row">
               ...
               <select class="form-control" onchange="toggle()" id="select">
...
<script>
function toggle() {
	var Parmanent =document.getElementById('Parmanent');
	if (Parmanent.style.display=='none') {
		Parmanent.style.display='block';
	}
	else{
		Parmanent.style.display='none';
	}
}
</script>
</body>
